export function buildOracleDispatchPrompt(request: string): string {
  return [
    ...
    "3. Select the exact relevant files/directories for the oracle archive from files that actually exist in the repo.",
    ...
    "- Never invent file names or placeholders. Only include paths you have confirmed exist in the current repo.",
    "- If a desired file does not exist (for example, CONTEXT.md), use a real alternative that exists instead.",
